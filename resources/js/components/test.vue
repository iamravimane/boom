<template>
  ...
  <div class="row">
	<div class="col-sm-9 col-md-9">
      <p class="pop-heading">Search <span>Results</span> </p> 
    ...
    <div class="col-sm-12 col-md-12" v-for="reports in results" :key="reports.rep_id">
      ...
      <p class="pop-reports-desc">{{reports.rep_descrip.substring(0, 300)+'...'}}</p>
    ...
    <div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="0010" v-model="selectedRange" v-on:change="searching">Up to $1000</label>
                  </div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="1020" v-model="selectedRange" v-on:change="searching">$1000-$2000</label>
                  </div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="2030" v-model="selectedRange" v-on:change="searching">$2000-$3000</label>
                  </div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="3040" v-model="selectedRange" v-on:change="searching">$3000-$4000</label>
                  </div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="4050" v-model="selectedRange" v-on:change="searching">$4000-$5000</label>
                  </div>
                  <div class="radio">
                  <label><input type="radio" name="price" value="5000" v-model="selectedRange" v-on:change="searching">Above $5000</label>
                  </div>
